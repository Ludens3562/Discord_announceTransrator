...
1. Issue エージェントを呼び出し、イシューを作成する
2. Plan エージェントを呼び出し、実装計画を立てる
3. Impl エージェントを呼び出し、実装を行う
4. Review エージェントを呼び出し、コードレビューと修正を行う
5. 必要に応じてステップ 3 と 4 を繰り返す
6. Document エージェントを呼び出し、ドキュメントの更新を行う 
7. PR エージェントを呼び出し、プルリクエストを作成する
